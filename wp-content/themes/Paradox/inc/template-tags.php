		...
		echo '" class="comment-body media">';
			...
			echo '<div class="comment-content media-body">';
				...
				comment_reply_link(array_merge($args, array(
					...
					'reply_text' => '<span class="fa fa-reply"></span> ' . __('Reply'),
					'login_text' => '<span class="fa fa-reply"></span> ' . __('Log in to Reply')
				)));
				// end reply link
...
function bootstrapBasicPostOn() 
{
	...
	// 	$time_string .= '<time class="updated" datetime="%3$s">%3$s</time>';
	// }
